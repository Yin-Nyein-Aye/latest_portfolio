...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        Dedicated and detail‑oriented full‑stack developer with a passion for
        solving real‑world problems. Skilled in modern frontend frameworks and
        robust backend technologies, I deliver seamless, responsive, and
      ...
      <div className="space-x-5 mt-5">
        <motion.a
          ...
          className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-orange-400 via-olive-500 to-orange-400 rounded-lg font-extrabold text-olive-800 text-xs sm:text-base shadow-[inset_0_0_18px_black]"
        >
          View My Work
          <svg
        ...
        <motion.a
          ...
          whileHover={{ scale: 1.1 }}
          className="inline-flex items-center px-3 py-2 bg-gradient-to-r from-orange-400 via-olive-500  to-orange-400 rounded-lg font-extrabold text-olive-800 shadow-[inset_0_0_18px_black]  text-sm sm:text-base"
