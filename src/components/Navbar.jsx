...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex space-x-6 text-shadow-[0_0_10px_white]">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="hidden md:block bg-orange-400 text-black px-2 py-1 rounded-full hover:bg-orange-500 transition shadow-[inset_0_0_10px_white] hover:shadow-[0_0_15px_orange] text-sm font-semibold"
